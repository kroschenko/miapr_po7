...
def adaptive_alpha(reference_arr,amount_inputs,shift):
    temp = 0
    for i in range(amount_inputs):
        temp += reference_arr[i+shift]**2
    return 1 / (1 + temp)
...
def main():
    ...
    while error >min_еrror:
        ...
        for i in range(train_epoch - amount_inputs):
            ...
            t_alpha = adaptive_alpha(reference_arr, amount_inputs, i)
