...
class NN:
    ...
    def __init__(self):
        ...
        self.wx = np.random.normal(-1, 1, (8, 3))
        self.th = np.random.normal(-1, 1, 3)
        self.wh = np.random.normal(-1, 1, (3, 1))
        self.ty = np.random.normal(-1, 1, 1)
...
def main():
    ...
    for i in range(30_000):
        error = nn.learn(learn_x, learn_e, speed)
