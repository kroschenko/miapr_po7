...
def speed_training(training_output: List[float], i: int, inputs_number) -> float:
    speed_training = 0
    for j in range(inputs_number):
        speed_training += training_output[i + j]**2
...
def training(inputs_number: int, training_number: int, training_output: List[float]):
    ...
    while error > min_error:
        ...
        for i in range(training_number - inputs_number):
            ...
            training_speed = speed_training(training_output, i, inputs_number)
